(function () {
  const FILENAME = 'data/thesis/fig08/correlations.json';
  const FEATURES = [
  ...
  const svg = d3.select('#figure08-A')
    .append('svg')
  ...
  const tooltip = d3.select('#figure08-A')
    .append('div')
    .attr('class', 'tooltip')
    .style('opacity', 0);
